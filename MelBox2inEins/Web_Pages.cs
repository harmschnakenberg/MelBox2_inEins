...
namespace MelBox2
{
    ...
    public class TestResource
    {
        ...
        public IHttpContext ResponseRegister(IHttpContext context)
        {
            ...
            builder.Append(MelBoxWeb.HtmlAlert(2, "Bitte beachten", "Es ist zur Zeit keine Registrierungs-Prozedur implementiert. <a href='mailto:harm.schnakenberg@kreutztraeger.de'>Email</a>"));
